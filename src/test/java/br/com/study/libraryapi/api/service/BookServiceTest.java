...
import br.com.study.libraryapi.api.service.impl.BookServiceImpl;
...
class BookServiceTest {
        ...
        when(repository.save(book))
                .thenReturn(
                        Book.builder()
                                .id(1L)
                                .isbn("123")
                                .author("Fulano").title("As Aventuras")
                                .build());
        //Exec
    ...
    public void shouldNotSaveABookWithDuplicatedISBN(){
        ...
        //exec
        Throwable exThrowable =  Assertions.catchThrowable(()->service.save(book));

        assertThat(exThrowable)
    ...
    public void bookByIdButNotFoundTest(){
        Long id = 1L;
