...
import br.com.study.libraryapi.api.resource.LoanController;
import br.com.study.libraryapi.api.service.BookService;
import br.com.study.libraryapi.api.service.LoanService;
import br.com.study.libraryapi.api.service.LoanServiceTest;
...
public class LoanControllerTest {
    ...
    public void createLoanTeste() throws Exception{
    ...
    public void findLoanTest() throws Exception {
        ...
        String querString = String.format("?isbn=%s&customer=%s&page=0&size=10",book.getIsbn(),loan.getCustomer());
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get(LOAN_API.concat(querString))
                .accept(MediaType.APPLICATION_JSON);
        mvc.perform(request)
